...
describe('dot-checkbox', () => {
    ...
    it('renders', async () => {
        ...
        const expectedMarkup = `<dot-checkbox name=\"testName\" label=\"testLabel\" hint=\"testHint\" options=\"valueA|1,valueB|2,valueC|3\" value=\"1\" required-message=\"testErrorMsg\" required=\"true\" class=\"dot-valid dot-pristine dot-untouched dot-required hydrated\"><div class=\"dot-field__label\"><label for=\"dot-testName\">testLabel</label><span class=\"dot-field__required-mark\">*</span></div><input type=\"checkbox\" id=\"1\" value=\"1\"><div class=\"dot-field__label\"><label for=\"dot-1\">valueA</label></div><input type=\"checkbox\" id=\"2\" value=\"2\"><div class=\"dot-field__label\"><label for=\"dot-2\">valueB</label></div><input type=\"checkbox\" id=\"3\" value=\"3\"><div class=\"dot-field__label\"><label for=\"dot-3\">valueC</label></div><span class=\"dot-field__hint\">testHint</span></dot-checkbox>`;
    ...
    it('should be invalid, touched & dirty and the error msg should display', async () => {
        ...
        await page.waitForChanges();
        // tslint:disable-next-line:max-line-length
        expect(element.outerHTML).toBe(`<dot-checkbox name=\"testName\" label=\"testLabel\" hint=\"testHint\" options=\"valueA|1,valueB|2,valueC|3\" value=\"1\" required-message=\"testErrorMsg\" required=\"true\" class=\"dot-required hydrated dot-invalid dot-dirty dot-touched\"><div class=\"dot-field__label\"><label for=\"dot-testName\">testLabel</label><span class=\"dot-field__required-mark\">*</span></div><input class=\"dot-field__error\" type=\"checkbox\" id=\"1\" value=\"1\"><div class=\"dot-field__label\"><label for=\"dot-1\">valueA</label></div><input class=\"dot-field__error\" type=\"checkbox\" id=\"2\" value=\"2\"><div class=\"dot-field__label\"><label for=\"dot-2\">valueB</label></div><input class=\"dot-field__error\" type=\"checkbox\" id=\"3\" value=\"3\"><div class=\"dot-field__label\"><label for=\"dot-3\">valueC</label></div><span class=\"dot-field__hint\">testHint</span><span class=\"dot-field__error-message\">testErrorMsg</span></dot-checkbox>`);
