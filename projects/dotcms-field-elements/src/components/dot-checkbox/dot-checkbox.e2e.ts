...
describe('dot-checkbox', () => {
    ...
    it('renders', async () => {
        ...
        const expectedMarkup = `<dot-checkbox name=\"testName\" label=\"testLabel\" hint=\"testHint\" options=\"valueA|1,valueB|2,valueC|3\" value=\"1\" required-message=\"testErrorMsg\" required=\"true\" class=\"dot-valid dot-pristine dot-untouched hydrated\"><label for=\"testName\">testLabel</label><input type=\"checkbox\" id=\"1\" value=\"1\"><label for=\"1\">valueA</label><input type=\"checkbox\" id=\"2\" value=\"2\"><label for=\"2\">valueB</label><input type=\"checkbox\" id=\"3\" value=\"3\"><label for=\"3\">valueC</label><span class=\"dot-field__hint\">testHint</span></dot-checkbox>`;
    ...
    it('should be invalid, touched & dirty and the error msg should display', async () => {
        ...
        await page.waitForChanges();
        // tslint:disable-next-line:max-line-length
        expect(element.outerHTML).toBe(`<dot-checkbox name=\"testName\" label=\"testLabel\" hint=\"testHint\" options=\"valueA|1,valueB|2,valueC|3\" value=\"1\" required-message=\"testErrorMsg\" required=\"true\" class=\"hydrated dot-invalid dot-dirty dot-touched\"><label for=\"testName\">testLabel</label><input class=\"dot-field__error\" type=\"checkbox\" id=\"1\" value=\"1\"><label for=\"1\">valueA</label><input class=\"dot-field__error\" type=\"checkbox\" id=\"2\" value=\"2\"><label for=\"2\">valueB</label><input class=\"dot-field__error\" type=\"checkbox\" id=\"3\" value=\"3\"><label for=\"3\">valueC</label><span class=\"dot-field__hint\">testHint</span><span class=\"dot-field__error-meessage\">testErrorMsg</span></dot-checkbox>`);
