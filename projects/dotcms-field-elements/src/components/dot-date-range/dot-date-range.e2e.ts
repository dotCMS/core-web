...
describe('dot-date-range', () => {
    ...
    it('should render', () => {
        ...
        const tagsRenderExpected = `<dot-date-range label=\"Name:\" min=\"2019-01-01\" max=\"2019-12-31\" name=\"dateRange\" value=\"2019-05-01,2019-05-08\" hint=\"this is a hint\" required=\"true\" required-message=\"Required Name\" class=\"dot-valid dot-pristine dot-untouched dot-required hydrated\"><div class=\"dot-field__label\"><label for=\"dot-dateRange\">Name:</label><span class=\"dot-field__required-mark\">*</span></div><input id=\"dot-dateRange\" required=\"\" type=\"text\"><select><option value=\"0\">Date Presets</option><option value=\"-7\">Last Week</option><option value=\"7\">Next Week</option><option value=\"-30\">Last Month</option><option value=\"30\">Next Month</option></select><span class=\"dot-field__hint\">this is a hint</span></dot-date-range>`;
    ...
    describe('disabled', () => {
        it('should render', async() => {
            ...
            await page.waitForChanges();
            // tslint:disable-next-line:max-line-length
            const tagsRenderExpected = `<dot-date-range label=\"Name:\" min=\"2019-01-01\" max=\"2019-12-31\" name=\"dateRange\" value=\"2019-05-01,2019-05-08\" hint=\"this is a hint\" required=\"true\" required-message=\"Required Name\" class=\"dot-valid dot-pristine dot-untouched dot-required hydrated\"><div class=\"dot-field__label\"><label for=\"dot-dateRange\">Name:</label><span class=\"dot-field__required-mark\">*</span></div><input id=\"dot-dateRange\" required=\"\" type=\"text\" disabled=\"\"><select disabled=\"\"><option value=\"0\">Date Presets</option><option value=\"-7\">Last Week</option><option value=\"7\">Next Week</option><option value=\"-30\">Last Month</option><option value=\"30\">Next Month</option></select><span class=\"dot-field__hint\">this is a hint</span></dot-date-range>`;
            expect(element.outerHTML).toBe(tagsRenderExpected);
        });
    });
});
