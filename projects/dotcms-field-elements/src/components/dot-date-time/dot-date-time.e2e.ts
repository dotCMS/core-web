...
describe('dot-date-time', () => {
    ...
    it('should render', () => {
        ...
        const tagsRenderExpected = `<dot-date-time label=\"Date and Time:\" name=\"dt01\" value=\"2019-01-20 11:10:00\" hint=\"date time hint\" required=\"\" required-message=\"Required Date Time\" validation-message=\"Value out of range\" min=\"2000-01-01 01:00:00\" max=\"2020-10-30 23:30:59\" step=\"2,10\" class=\"dot-valid dot-pristine dot-untouched dot-required hydrated\"><div class=\"dot-field__label\"><label for=\"dot-dt01\" id=\"label-dt01\">Date and Time:</label><span class=\"dot-field__required-mark\">*</span></div><label>Date:<dot-input-calendar type=\"date\" required-message=\"Required Date Time\" validation-message=\"Value out of range\" class=\"hydrated\"><input id=\"dot-dt01-date\" required=\"\" type=\"date\" min=\"2000-01-01\" max=\"2020-10-30\" step=\"2\"></dot-input-calendar></label><label>Time:<dot-input-calendar type=\"time\" required-message=\"Required Date Time\" validation-message=\"Value out of range\" class=\"hydrated\"><input id=\"dot-dt01-time\" required=\"\" type=\"time\" min=\"01:00:00\" max=\"23:30:59\" step=\"10\"></dot-input-calendar></label><span class=\"dot-field__hint\" id=\"hint-dt01\">date time hint</span></dot-date-time>`;
