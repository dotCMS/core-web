...
describe('dot-textarea', () => {
    ...
    it('should render', async () => {
        ...
        const tagsRenderExpected = `<div class=\"dot-field__label\"><label for=\"dot-Address\">Address:</label></div><textarea id=\"Address\" name=\"Address\"></textarea>`;
    ...
    it('should render with hint', async () => {
        ...
        await page.waitForChanges();
        // tslint:disable-next-line:max-line-length
        const tagsRenderExpected = `<div class=\"dot-field__label\"><label for=\"dot-Address\">Address:</label></div><textarea id=\"Address\" name=\"Address\"></textarea><span class=\"dot-field__hint\">this is a hint</span>`;
        expect(element.innerHTML).toBe(tagsRenderExpected);
    });
});
