...
| `keyPlaceholder`   | `key-placeholder`   | (optional) Placeholder for the key input text         | `any`     | `null`    |
| `valueLabel`       | `value-label`       | (optional) The string to use in the value input label | `string`  | `'Value'` |
| `valuePlaceholder` | `value-placeholder` | (optional) Placeholder for the value input text       | `any`     | `null`    |
