...
describe('dot-form', () => {
    ...
    it('should renders', async () => {
        ...
        const tagsRenderExpected = `<form><dot-textfield class=\"dot-valid dot-pristine dot-untouched dot-required hydrated\"><div class=\"dot-field__label\"><label for=\"dot-field1\" id=\"label-field1\">field1</label><span class=\"dot-field__required-mark\">*</span></div><input id=\"dot-field1\" required=\"\" type=\"text\"><span class=\"dot-field__hint\" id=\"hint-field1\">hint1</span></dot-textfield><dot-textfield class=\"dot-valid dot-pristine dot-untouched hydrated\"><label for=\"dot-field2\" id=\"label-field2\">field2</label><input id=\"dot-field2\" type=\"text\"><span class=\"dot-field__hint\" id=\"hint-field2\">hint2</span></dot-textfield><div class=\"form__buttons\"><button type=\"button\">Reseted</button><button type=\"submit\">Saved</button></div></form>`;
