...
describe('dot-radio', () => {
    ...
    it('renders', async () => {
        ...
        const expectedMarkup = `<dot-radio name=\"testRadio\" label=\"testLabel\" hint=\"testHint\" options=\"valueA|1,valueB|2,valueC|3\" value=\"2\" required=\"true\" required-message=\"testErrorMsg\" class=\"dot-valid dot-pristine dot-untouched hydrated\"><label for=\"testRadio\">testLabel</label><div class=\"dot-radio__items\"><div class=\"dot-radio__item\"><input type=\"radio\" id=\"dot-radio-valuea\" name=\"testradio\" value=\"1\"><label for=\"dot-radio-valuea\">valueA</label></div><div class=\"dot-radio__item\"><input type=\"radio\" id=\"dot-radio-valueb\" name=\"testradio\" value=\"2\"><label for=\"dot-radio-valueb\">valueB</label></div><div class=\"dot-radio__item\"><input type=\"radio\" id=\"dot-radio-valuec\" name=\"testradio\" value=\"3\"><label for=\"dot-radio-valuec\">valueC</label></div></div><span class=\"dot-field__hint\">testHint</span></dot-radio>`;
