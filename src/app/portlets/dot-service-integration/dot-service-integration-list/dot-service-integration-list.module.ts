...
import { DotServiceIntegrationPageResolver } from './dot-service-integration-list-resolver.service';
...
@NgModule({
    ...
    providers: [DotServiceIntegrationService, DotServiceIntegrationPageResolver]
})
