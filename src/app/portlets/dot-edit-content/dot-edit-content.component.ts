...
export class DotEditContentComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        iframeEl.addEventListener('load', () => this.addEditButton(iframeEl));
    ...
    private addEditButton(iframeEl: any): void {
        const editContents: HTMLElement[] = iframeEl.contentDocument.getElementsByTagName('edit-contentlet');
