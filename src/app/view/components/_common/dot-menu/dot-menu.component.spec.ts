...
describe('DotMenuComponent', () => {
    ...
    it('should set visible to true and show the menu list', () => {
        const button: DebugElement = fixture.debugElement.query(By.css('.dot-menu-button'));
        button.triggerEventHandler('click', {});
        fixture.detectChanges();

        const menulist: DebugElement = fixture.debugElement.query(By.css('.dot-menu-list'));
