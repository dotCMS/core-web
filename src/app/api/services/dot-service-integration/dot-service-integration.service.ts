...
export class DotServiceIntegrationService {
    ...
    /**
     * Return a list of configurations of a specific Service Integration
     * @param {string} serviceKey
     * @returns Observable<DotServiceIntegration>
     * @memberof DotServiceIntegrationService
     */
    getConfigurationList(serviceKey: string): Observable<DotServiceIntegration> {
        return this.coreWebService
            .requestView({
                method: RequestMethod.Get,
    ...
    /**
     * Return a detail configuration of a specific Service Integration
     * @param {string} serviceKey
     * @param {string} id
     * @returns Observable<DotServiceIntegration>
     * @memberof DotServiceIntegrationService
     */
    getConfiguration(serviceKey: string, id: string): Observable<DotServiceIntegration> {
        return this.coreWebService
            .requestView({
                method: RequestMethod.Get,
     ...
     * @memberof DotServiceIntegrationService
     */
    saveSiteConfiguration(serviceKey: string, id: string, params: { [key: string]: string }): any {
        return this.coreWebService
            .requestView({
                body: {
                    params
