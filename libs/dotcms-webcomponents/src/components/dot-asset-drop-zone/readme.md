...
| `customUploadFile`       | --                           |                                                                      | `(props: { data: File[]; hideOverlay: () => void; progressCallBack: (progress: number) => void; showDialog: (header: string, message: string) => void; }) => Promise<any>` | `undefined`                                                                                                                                                                                |
