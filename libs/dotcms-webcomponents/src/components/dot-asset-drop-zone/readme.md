...
| `customUploadFiles`      | --                           |                                                                      | `(props: { files: File[]; onSuccess: () => void; updateProgress: (progress: number) => void; showDialog: (header: string, message: string) => void; }) => Promise<any>` | `undefined`                                                                                                                                                                                |
